...
parser.add_argument("--n_residual", type=int, default=1, help="number of redidual blocks in encoder")
parser.add_argument("--saved_model_path", type=str, default="../artifacts/", help="Path from where you want to reload a model.")
parser.add_argument("--dim", type=int, default=8, help="number of filters in first encoder layer")
